...
namespace RCLargeLanguageModels.Parsing
{
	...
	public struct ParsedRule
	{
		...
		/// </summary>
		public ImmutableList<ParsedRule> rules;

		/// <summary>
		/// Gets the parsed value factory associated with this rule.
		/// </summary>
		public Func<ParsedRuleResult, object?>? parsedValueFactory;
		...
		/// <param name="parsedValueFactory">The parsed value factory associated with this rule.</param>
		...
		public ParsedRule(int ruleId, int startIndex, int length, ParsedToken token,
			Func<ParsedRuleResult, object?>? parsedValueFactory = null, object? intermediateValue = null)
		{
			this.success = true;
			this.ruleId = ruleId;
		...
		/// <param name="parsedValueFactory">The parsed value factory associated with this rule.</param>
		/// <param name="intermediateValue">The intermediate value associated with this rule.</param>
		public ParsedRule(int ruleId, int startIndex, int length, ImmutableList<ParsedRule> rules,
			Func<ParsedRuleResult, object?>? parsedValueFactory = null, object? intermediateValue = null)
		{
			this.success = true;
			this.ruleId = ruleId;
		...
		private ParsedRule(bool success, int ruleId, int startIndex, int length,
			bool isToken, ParsedToken token, int occurency, ImmutableList<ParsedRule> rules,
			Func<ParsedRuleResult, object?>? parsedValueFactory = null, object? intermediateValue = null)
		{
		...
		/// </summary>
		public static ParsedRule Fail { get; } = new ParsedRule(false, -1, -1, 0, false, ParsedToken.Fail, -1, ImmutableList<ParsedRule>.Empty, null, null);
	}
}