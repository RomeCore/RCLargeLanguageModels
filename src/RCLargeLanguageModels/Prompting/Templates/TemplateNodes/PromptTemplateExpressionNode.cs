...
namespace RCLargeLanguageModels.Prompting.Templates.TemplateNodes
{
	...
	/// </summary>
	public class PromptTemplateExpressionNode : PromptTemplateNode
	{
		/// <summary>
		...
		/// <summary>
		/// Creates a new instance of the <see cref="PromptTemplateExpressionNode"/> class.
		/// </summary>
		...
		public PromptTemplateExpressionNode(TemplateExpressionNode expression, string? format = null)
		{
