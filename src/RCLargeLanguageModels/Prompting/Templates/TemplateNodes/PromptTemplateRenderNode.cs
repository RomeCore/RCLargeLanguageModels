...
{
	/// <summary>
	/// Represents a node in the prompt template that renders another template.
	/// </summary>
	public class PromptTemplateRenderNode : PromptTemplateNode
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PromptTemplateRenderNode"/> class.
		/// </summary>
		...
		public PromptTemplateRenderNode(TemplateExpressionNode name, TemplateExpressionNode? context)
		{
